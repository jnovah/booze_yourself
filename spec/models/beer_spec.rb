...
beer = Beer.create!(name: "#NOHOLDSIE Holdsie Da Deuce", description: "Rye Tripel aged in red Wine Barrels", abv: "8.2", img: nil, avg_score: nil, user_id: nil, brewery_id: nil, availability_id: nil, type_id: 59, brewery_db_id: "zrbNet")
